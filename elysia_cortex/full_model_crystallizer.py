...
class FullModelCrystallizer:
    ...
    def crystallize_model(self, targeted_layers=None, base_rotors=27):
        ...
        output_path = "elysia_cortex/outputs/full_model_crystal.json"
...
if __name__ == "__main__":
    ...
    import sys
    from elysia_cortex.sovereign_selector import SovereignSelector
    from elysia_cortex.journal_manager import JournalManager
