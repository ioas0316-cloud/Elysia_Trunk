...
class PhaseBenchmark:
    ...
    """
    def __init__(self, sovereign_crystal_path="elysia_cortex/outputs/full_model_crystal.json"):
    ...
    def generate_interference_plot(self, giant_energies, output_path=None):
        ...
        if output_path is None:
            output_path = f"elysia_cortex/outputs/interference_{model_id}.html"
    ...
    def generate_rotor_distribution_plot(self, output_path=None):
        ...
        model_id = self.crystal["metadata"]["model_id"].replace("/", "_")
        if output_path is None:
            output_path = f"elysia_cortex/outputs/rotors_{model_id}.html"
