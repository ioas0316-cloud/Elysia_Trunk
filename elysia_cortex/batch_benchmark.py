...
import json
import numpy as np
from elysia_cortex.full_model_crystallizer import FullModelCrystallizer
from elysia_cortex.phase_benchmark import PhaseBenchmark
    ...
    for model_id in model_ids:
        for num_rotors in rotor_counts:
            ...
            try:
                ...
                # but FullModelCrystallizer currently hardcodes to elysia_cortex/outputs/full_model_crystal.json
                # Let's fix that or rename after each run.

                crystal_filename = f"elysia_cortex/outputs/crystal_{model_id.replace('/', '_')}_r{num_rotors}.json"
