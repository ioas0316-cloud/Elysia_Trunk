...
def run_experiment():
    ...
    os.makedirs("elysia_cortex/outputs", exist_ok=True)
    os.makedirs("elysia_cortex/archive", exist_ok=True)
    ...
    viz_path = "elysia_cortex/outputs/pythagoras_trajectory.html"
    fig.write_html(viz_path)

    audio_data = microscope.generate_resonance_audio(imbalance)
    audio_path = "elysia_cortex/outputs/pythagoras_resonance.wav"
